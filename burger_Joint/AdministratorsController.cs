...
namespace burger_Joint
{
    ...
    public class AdministratorsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Administrator>> PostAdministrator(Administrator administrator)
        {
            ...
            return CreatedAtAction("GetAdministrator", new { id = administrator.Administrator_ID }, administrator);
        }
        ...
        {
            return _context.Administrators.Any(e => e.Administrator_ID == id);
        }
    }
}
